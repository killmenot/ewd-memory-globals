...
const debug = require('debug')('ewd-memory-globals:deleteMembersByPrefix');
const keyExists = require('./keyExists');

function deleteMembersByPrefix(key, prefixValue) {
  debug('key = %s, prefixValue = %s', key, prefixValue);
...
module.exports = deleteMembersByPrefix;

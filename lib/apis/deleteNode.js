...
const debug = require('debug')('ewd-memory-global:deleteNode');
...
function parse(result) {
  return typeof result !== 'undefined' && result !== null ? parseInt(result, 10) : result;
}
    ...
    do {
      ...
      if (subscripts.length > 0) {
        ...
        if (commands.countMembers.call(this, childrenKey) === 0) {
          ...
          result = parse(commands.getProperty.call(this, nodeKey, 'data'));
        ...
        if (commands.countMembers.call(this, childrenRoot) === 0) {
          ...
          result = parse(commands.getProperty.call(this, nodeRoot, 'data'));

...
const deleteKeys = require('../../../lib/commands/deleteKeys');
...
describe('commands/deleteKeys', () => {
  ...
  it('should delete keys matching keys', () => {

    expect(keyExists.call(db, 'foo')).toBeTruthy();
    expect(keyExists.call(db, 'baz')).toBeTruthy();

    deleteKeys.call(db, ['foo', 'baz']);

    expect(keyExists.call(db, 'foo')).toBeFalsy();
    expect(keyExists.call(db, 'baz')).toBeFalsy();
  });
});
